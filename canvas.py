...
while(1):
    ...
    if canvas is None:
        ...
        #canvas = cv2.resize(cv2.imread('c://Users//osama//Desktop//image//pen.jpg',1), (1280, 720))

        canvas = np.zeros_like(frame)
        canvas[np.where((canvas==[0,0,0]).all(axis=2))] = [0,128,128]
    ...
    if k == ord('s'):
        print(type(canvas))
        cv2.imwrite('c://Users//osama//Desktop//image//save//EI.jpg',canvas)
        break
